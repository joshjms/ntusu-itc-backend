...
class Booking(models.Model): 
    ...
    payment_status = models.TextChoices(choices=PaymentStatus.choices, default=PaymentStatus.PENDING)
    status = models.TextChoices(choices=AllocationStatus.choices, default=AllocationStatus.PENDING)
